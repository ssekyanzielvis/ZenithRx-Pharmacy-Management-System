...
export const INITIAL_DRUGS: DrugItem[] = [
  ...
  {
    id: 'DRUG-011',
    brandName: 'Amoxiclav 625mg',
    genericName: 'Amoxicillin + Clavulanate Potassium',
    barcode: '8901234567801',
    batchNumber: 'AMC-2026-04',
    category: 'Antibiotics',
    ...
    manufacturer: 'Medreich / Quality Chemical QCIL',
    prescriptionRequired: true,
    unit: 'tablets (pack 14s)'
  },
  {
    id: 'DRUG-012',
    brandName: 'Klavox 625mg',
    genericName: 'Amoxicillin + Clavulanate Potassium',
    barcode: '8901234567802',
    batchNumber: 'KLV-2026-07',
    category: 'Antibiotics',
    ...
    manufacturer: 'Spimaco Pharmaceuticals',
    prescriptionRequired: true,
    unit: 'tablets (pack 14s)'
  },
  {
    id: 'DRUG-013',
    brandName: 'Metformin 850mg Generic',
    genericName: 'Metformin Hydrochloride',
  ...
  {
    id: 'DRUG-014',
    brandName: 'Amlodipine 5mg Generic',
    genericName: 'Amlodipine Besylate',
    barcode: '8901234567804',
    batchNumber: 'AML-2026-05',
    category: 'Cardiovascular',
    shelfLocation: 'Rack C-05',
    costPrice: 180,
    sellingPrice: 320,
    stockQty: 140,
    reorderLevel: 30,
    expiryDate: '2027-08-15',
    manufacturer: 'Cipla Quality Chemical QCIL',
    prescriptionRequired: true,
    unit: 'pack (30 tablets)'
  },
  {
    id: 'DRUG-015',
    brandName: 'Atorvastatin 20mg Generic',
    genericName: 'Atorvastatin Calcium',
    barcode: '8901234567805',
    batchNumber: 'ATV-2026-08',
    category: 'Cardiovascular',
    shelfLocation: 'Rack C-03',
    costPrice: 500,
    sellingPrice: 850,
    stockQty: 95,
    reorderLevel: 25,
  ...
  },
  {
    ...
    batchNumber: 'AST-2026-03',
    category: 'Respiratory',
    shelfLocation: 'Rack R-02',
    costPrice: 520,
    sellingPrice: 820,
    stockQty: 45,
    reorderLevel: 15,
  ...
  {
    id: 'DRUG-017',
    brandName: 'Esomeprazole 40mg Generic',
    genericName: 'Esomeprazole Magnesium',
    barcode: '8901234567807',
    batchNumber: 'ESO-2026-09',
    category: 'Gastrointestinal',
    shelfLocation: 'Rack G-03',
    costPrice: 550,
    sellingPrice: 900,
    stockQty: 70,
    reorderLevel: 20,
  ...
  {
    id: 'DRUG-018',
    brandName: 'Azithromycin 500mg Generic',
    genericName: 'Azithromycin Monohydrate',
    barcode: '8901234567808',
    batchNumber: 'AZI-2026-11',
    category: 'Antibiotics',
    shelfLocation: 'Rack A-06',
    costPrice: 420,
    sellingPrice: 700,
    stockQty: 55,
    reorderLevel: 15,
    expiryDate: '2027-07-14',
    manufacturer: 'Quality Chemical QCIL',
    prescriptionRequired: true,
    unit: 'pack (3 tablets)'
  }
];
